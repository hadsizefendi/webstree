<template>
  <div>
    ...
    <UContainer class="py-8">
      ...
      <UCard
        class="overflow-hidden relative mb-8"
        :ui="{
          rounded: $settings.uiConfig.rounded,
          shadow: $settings.uiConfig.shadow,
          background: $settings.uiConfig.background,
      ...
      <div
        ...
        class="fixed bottom-4 right-4 z-50 flex gap-2"
      >
        <UButton
          color="gray"
          variant="solid"
        ...
        <UButton
          color="red"
          variant="solid"
          :label="`Delete ${selectedItems.length} selected items`"
          ...
          @click="confirmDelete({ ids: selectedItems })"
        />
      </div>
      <div class="flex flex-wrap gap-3 items-center justify-center">
        ...
        >
          ...
          <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
            Get started by adding new media.
          </p>
        </div>
      </div>
      ...
      <MediaPreview
        v-model="showPreview"
        :media="selectedMedia"
        @delete="confirmDelete(selectedMedia)"
      />
      <UModal
        ...
        <div class="p-6">
          ...
          <div class="flex justify-end gap-3">
            ...
            <UButton
              ...
              @click="deleteMedia(mediaToDelete)"
            />
          </div>
        </div>
      </UModal>
