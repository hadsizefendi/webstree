          ...
          >
            ...
            <div class="space-y-4">
              ...
              <MediaSelector
                ...
                default-image="/images/product.webp"
              />
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 space-y-6">
              ...
              <div class="space-y-4">
                ...
                <USelectMenu
                  ...
                  searchable-placeholder="Kategori ara..."
                  multiple
                  searchable
                  :ui="{
                    rounded: $settings.uiConfig.rounded,
                    ...
                    <template v-if="selectedCategoryIds.length">
                      <div class="flex items-center gap-2">
                        <div class="flex -space-x-2">
                          <UAvatar
                            v-for="category in selectedCategoryIds"
                            :key="category._id"
                            :src="category.image"
                            :alt="category.title"
                            size="2xs"
                    ...
                    <div class="text-center">
                      ...
                      <div>
                        ...
                        <p class="text-sm text-gray-500">
                          Add and edit your images and videos
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <div class="space-y-8">
        ...
        >
          <UCard
            ...
            :class="{ 'ring-2 ring-primary-500': selectedItems.includes(product._id) }"
            :ui="{ body: { padding: '!p-0' },
                   rounded: $settings.uiConfig.rounded,
                   shadow: $settings.uiConfig.shadow,
                   background: $settings.uiConfig.background,
          ...
          >
            <div class="relative aspect-square">
              ...
              <!-- Selection Indicator -->
              <div
                v-if="selectedItems.includes(product._id)"
              ...
              >
                ...
                <UButton
                  ...
                  @click="toggleSelect(product._id, $event)"
                />
              </div>
              ...
              <div class="absolute inset-0 p-4">
                ...
                <p
                  ...
                  class="text-xs text-white opacity-0 group-hover:opacity-100 duration-500"
                >
