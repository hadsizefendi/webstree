...
<template>
  <div>
    ...
    <ULandingSection
      ...
      class="bg-white/10 dark:bg-black/10 overflow-hidden"
    >
      <UPageGrid
        id="features"
      ...
      >
        <UCard
          v-for="(item, featureIndex) in page.features.items"
          :key="featureIndex"
          v-motion="getMotion(featureIndex)"
          class="group"
          :ui="{
        ...
        >
          <template #default>
            <div class="flex flex-col items-center p-4">
              <UIcon
                :name="item.icon"
                class="w-12 h-12 mb-4 text-primary-500"
              />
    ...
    <ULandingSection
      :title="page.hizmet.title"
      :headline="page.hizmet.headline"
    ...
    >
      ...
      >
        <UCard
          v-for="(service, serviceIndex) in page.hizmet.items"
          :key="serviceIndex"
          v-motion="getMotion(serviceIndex)"
          class="p-1 group"
          :ui="{
            rounded: $settings.uiConfig.rounded,
            shadow: $settings.uiConfig.shadow,
                ...
                >
                  <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                      ...
                      <a
                        href="https://maps.app.goo.gl/6n3ZqQL7g68EySFN7"
                        target="_blank"
    ...
    >
      <ULandingFAQ
        v-for="(faq, faqIndex) in page.faq.items"
        :key="faqIndex"
        v-motion="getMotion(faqIndex)"
        :items="[faq]"
        :ui="{
          button: {
            label: 'font-semibold',
