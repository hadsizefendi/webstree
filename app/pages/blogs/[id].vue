<template>
  <div>
    <section class="py-8 px-4 max-w-4xl mx-auto space-y-6">
      <UButton block label="Go Back" icon="i-heroicons-arrow-left" variant="outline" size="xs" @click="goBack" :ui="{
      ...
      <div v-if="blog" class="space-y-6 bg-black/50 rounded-lg p-10">
        <div>
        ...
        <div v-if="blog.videoUrl" class="mt-6">
